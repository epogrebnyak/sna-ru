...
doc3 = """коды	2014	2015	2016	2017	2018
W2	37049324,8	39438178,4	41125144,9	43751475,2	48053052,0
W_row	-381133,2	-307314,6	-120218,9	-132844,6	-191316,2
D.2	11497946,8	9787221,1	9942260,5	10508160,8	12769698,8
D.3	493706,9	516204,9	523413,9	522587,5	544797,6
D.4r	1622955,0	2070853,7	2460666,6	2481226,8	3071599,9
	80300305,9	84857843,7	88354652,0	94449730,0	106756084,1
D.4p	3815331,9	3933121,8	4676138,0	4797296,7	5488729,5
B.5*g	76484974,0	80924721,9	83678514,0	89652433,3	101267354,6
"""


# Валовый располагаемый доход - B.6*g
...
renamer = {
    ...
    "W_row": (
        "сальдо заработной платы, полученной за границей"
        "и выплаченной в России нерезидентам",
        "W_row",
    ),
    "D.4r": ('Доходы от собственности, полученные от "остального мира"', "Rr"),
    "D.4p": ('Доходы от собственности, переданные "остальному миру"', "Rp"),
    "B.5*g": ("Gross national income", "GNI"),
}
...
gdi = gni + df_last.CT_recieved - df_last.CT_paid
assert eq(gdi, df_last.GDI)
assert eq(df.C, df_last.HH1 + df_last.HH2 + df_last.G)

S = gdi - (df_last.HH1 + df_last.HH2 + df_last.G)
assert eq(S, df_last.S)

NL = S + df_last.d9_recieved - df_last.d9_paid - df_last.GFCF - df_last.inv - df_last.k2
